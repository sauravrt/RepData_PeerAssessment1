...
intervals <- levels(as.factor(data.new$interval))
mean.steps <- unlist(steps.new.interval.mean)
end.idx <- data.new$daytype == "weekend"
plot(x = intervals[end.idx] , y = mean.steps[end.idx], type = 'l', xlab = "interval", ylab = "avg. steps")
